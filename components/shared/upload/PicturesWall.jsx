...
class PicturesWall extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <Upload customRequest={this.photoUpload} onRemove={this.handleFileRemove} accept="image/png,image/jpeg" response={false} listType="picture-card" fileList={fileList.length ? fileList : currentImages} onPreview={this.handlePreview} onChange={this.handleChange}>
